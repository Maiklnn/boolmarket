  ...
  _createClass(Run, [{
    ...
    value: function events() {
      ...
      document.addEventListener('click', function (e) {
        ...
        if (_this.target.closest('[data-burger]')) _this.mobileMenu();
      });
    }
  }, {
    key: "mobileMenu",
    value: function mobileMenu() {
      var burger = this.target.closest('[data-burger]');
      burger.classList.toggle('open');
      var menu = document.querySelector(".".concat(burger.dataset.burger));
    ...
    value: function sliders() {
      ...
      new Swiper(document.querySelector(".".concat(nameSlider, "__box")), {
        ...
        pagination: {
          type: 'bullets',
          // type: 'fraction',
          el: ".".concat(nameSlider, "-pagination"),
          clickable: true
        },
        breakpoints: {
          200: {
...
new Run();
{
  ...
  var Close = /*#__PURE__*/function (_Main) {
    _inherits(Close, _Main);
    var _super = _createSuper(Close);
    function Close(e) {
      var _this2;
      _classCallCheck(this, Close);
      _this2 = _super.call(this);
      _this2.element = e.element;
      _this2.close_window = document.querySelector("[data-target=\"".concat(_this2.element.dataset.close, "\"]"));
      _this2.modalContainer = _this2.close_window.querySelector(".modal-popup__container");
      _this2.modalContainer.classList.remove('animate-open');
      _this2.close_window.classList.remove('is-open');
      _this2.enableScroll();
      if (e.settings.indexOf('dom') === -1) {
        setTimeout(function () {
          _this2.close_window.remove();
        }, 5);
      }
      return _this2;
    }
  ...
  var Modal = /*#__PURE__*/function (_Main2) {
    _inherits(Modal, _Main2);
    var _super2 = _createSuper(Modal);
    function Modal(options) {
      var _this3;
      _classCallCheck(this, Modal);
      _this3 = _super2.call(this);
      _this3.modalPath = options.path;
    ...
    _createClass(Modal, [{
      ...
      value: function events() {
        var _this$options;
        // выпадает автоматом
        if ((_this$options = this.options) !== null && _this$options !== void 0 && _this$options.path) {
          var _this$options2;
          this.target = (_this$options2 = this.options) === null || _this$options2 === void 0 ? void 0 : _this$options2.path;
        ...
        document.addEventListener('click', function (e) {
          ...
          if (this.clickedElement) {
            ...
            var animation = this.clickedElement.dataset.animation;
            var speed = this.clickedElement.dataset.speed;
      ...
      key: "loadModal",
      value: function () {
        var _loadModal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var _this$options3;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (!(!((_this$options3 = this.options) !== null && _this$options3 !== void 0 && _this$options3.inDom) && this.window_options.indexOf('dom') === -1)) {
                  _context.next = 3;
                  break;
                }
                _context.next = 3;
                return this.setHtmlModal();
              case 3:
                // if not in dom
                this.openModal();
              case 4:
      ...
      key: "setHtmlModal",
      value: function () {
        var _setHtmlModal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var data, modal;
        ...
        function setHtmlModal() {
          return _setHtmlModal.apply(this, arguments);
        }
        return setHtmlModal;
      }()
    }, {
      ...
      value: function openModal() {
        var _this4 = this,
          _this$options4;
        this.modal = document.querySelector("[data-target=\"".concat(this.window_options[0], "\"]")); // search modal in dom
        if (!this.modal) return;
        this.modalContainer = this.modal.querySelector(".modal-popup__container");
        if (this.target === 'load') new Load({
          options: {
        ...
        var open = function open() {
          ...
          _this4.modal.classList.add('is-open');
          _this4.modalContainer.classList.add('modal-popup-open');
          setTimeout(function () {
            _this4.modalContainer.classList.add('animate-open');
          }, 0);
        };
        if ((_this$options4 = this.options) !== null && _this$options4 !== void 0 && _this$options4.timeout) {
          setTimeout(function () {
            open();
      ...
      key: "beforeModal",
      value: function beforeModal() {
        if (this.before === 'one') {
          var item = this.clickedElement.closest('.main-goods-item');
          var title = item.querySelector('.main-goods-item__name').textContent;
          var arrItems = [];
          arrItems.push('title', title);
          var json = JSON.stringify(arrItems);
          localStorage.setItem('arrItems', json);
        }
      }
    }]);
    return Modal;
  }(Main); // загрузка в модалку
  var Load = /*#__PURE__*/_createClass(function Load(options) {
  ...
  var Form = /*#__PURE__*/function () {
    ...
    _createClass(Form, [{
      ...
      value: function events() {
        ...
        document.addEventListener('click', function (e) {
          _this5.element = e.target;

          // mask
          if (_this5.element.dataset.mask) _this5.mask();

          // upload_files
          _this5.custom_file = _this5.element.closest('.custom-file');
          if (_this5.custom_file) {
            _this5.custom_file.addEventListener('change', function () {
              _this5.uploadFiles();
            });
          }

          // btn
          if (_this5.element.dataset.form) {
            e.preventDefault();
            _this5.form = _this5.element.closest('form');
            _this5.validate();
          }
        });
      }
      ...
      value: function getData() {
        ...
        this.formData = [].concat(_toConsumableArray(new FormData(this.form)), [['link', "".concat(document.location.href)], ['file', this.file]]); // данные формы

        // доп данные
        this.dataValue = this.form.querySelectorAll("[data-value]");
        this.dataValue.forEach(function (item) {
          var arrField = item.dataset.value.split("::");
          arrField.forEach(function (item) {
            ...
            _this7.formData.push(["".concat(field[0]), "".concat(field[1])]);
          });
        });
      ...
      key: "uploadFiles",
      value: function () {
        var _uploadFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
          var file, data, preview;
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                file = this.custom_file.querySelector('input[type="file"]').files[0];
                this.url = "upload.php";
              ...
              case 6:
                data = _context4.sent;
                preview = this.custom_file.querySelector('.custom-file__preview');
                preview.innerHTML = "<span path = '".concat(data.file, "''>\u0424\u0430\u0439\u043B \u043F\u0440\u0438\u043A\u0440\u0435\u043F\u043B\u0451\u043D (\u0438\u0437\u043C\u0435\u043D\u0438\u0442\u044C)</span>");
              case 9:
              case "end":
  ...
  window.addEventListener("DOMContentLoaded", function () {
    document.addEventListener('click', function (e) {
      ...
      // fag
      var $detail = element.closest('*[data-detail]');
      if ($detail) {
        e.preventDefault();
        ...
        $detail.parentElement.querySelectorAll('*[data-detail]').forEach(function (item) {
...
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('page-objects__cats-item')) {
    ...
    var list = document.querySelector('.list-objects');
    var objects = list.querySelectorAll('.page-objects__row');
    objects.forEach(function (item) {
      var data_str = item.dataset.cat;
